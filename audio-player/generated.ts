// Generated by @wagmi/cli@1.3.0 on 7/23/2023 at 5:17:04 AM
import {
  useContractRead,
  useContractWrite,
...
export const audioRegistryABI = [
  ...
  },
  {
    ...
    name: 'audioToEntry',
    outputs: [
      { name: 'microphoneAddress', internalType: 'address', type: 'address' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'ipfs', internalType: 'bytes32', type: 'bytes32' },
    ],
    name: 'dummyAddAudio',
    outputs: [],
  },
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link audioRegistryABI}__ and `functionName` set to `"audioHashLength"`.
 */
export function useAudioRegistryAudioHashLength(config = {}) {
  return useContractRead({
    abi: audioRegistryABI,
    functionName: 'audioHashLength',
    ...config,
  })
}

/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link audioRegistryABI}__ and `functionName` set to `"audioHashes"`.
 */
export function useAudioRegistryAudioHashes(config = {}) {
  return useContractRead({
    abi: audioRegistryABI,
    functionName: 'audioHashes',
    ...config,
  })
}

/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link audioRegistryABI}__ and `functionName` set to `"audioToEntry"`.
 */
export function useAudioRegistryAudioToEntry(config = {}) {
  return useContractRead({
    abi: audioRegistryABI,
    functionName: 'audioToEntry',
    ...config,
  })
}
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link audioRegistryABI}__ and `functionName` set to `"dummyAddAudio"`.
 */
export function useAudioRegistryDummyAddAudio(config = {}) {
  return useContractWrite({
    abi: audioRegistryABI,
    functionName: 'dummyAddAudio',
    ...config,
  })
}
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link audioRegistryABI}__ and `functionName` set to `"dummyAddAudio"`.
 */
export function usePrepareAudioRegistryDummyAddAudio(config = {}) {
